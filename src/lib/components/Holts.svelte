	...
	<div class="container">
		<div class="section-header holts-header">
			<span class="section-eyebrow holts-eyebrow">
				<span style="font-family: Arial, sans-serif;">&rarr;</span> IN PARTNERSHIP WITH HOLT RENFREW OGILVY
			</span>
			<h2 class="section-title holts-title">THE BIG RACE 2026</h2>

			<div class="holts-description">
				<p>
					Within the iconic Holt Renfrew Ogilvy, a curated Race Week activation where fashion, art,
					and culture converge.
				</p>
				<p>
					The refined space is transformed into an experiential showcase featuring immersive
					moments, artistic expressions, and a program designed to reflect the energy and
					sophistication of Montreal’s Race Week in an elevated setting.
				</p>
			</div>
		</div>
		...
		<div class="video-grid">
			<video class="holt-video" autoplay loop muted playsinline preload="auto">
				<source
					src="https://vngekjtqbdnfeombtjnx.supabase.co/storage/v1/object/public/gp26-assets/Holt/Day_1.webm"
					type="video/webm"
				/>
			</video>
			...
			<video class="holt-video" autoplay loop muted playsinline preload="auto">
				<source
					src="https://vngekjtqbdnfeombtjnx.supabase.co/storage/v1/object/public/gp26-assets/Holt/Day_2.webm"
					type="video/webm"
				/>
			</video>
			...
			<video class="holt-video" autoplay loop muted playsinline preload="auto">
				<source
					src="https://vngekjtqbdnfeombtjnx.supabase.co/storage/v1/object/public/gp26-assets/Holt/Day_3.webm"
					type="video/webm"
				/>
			</video>
		</div>
		...
		<div class="compact-footer">
			...
			<div class="holts-action-compact">
				<a href={holtsData.rsvpUrl} target="_blank" rel="noopener" class="btn-sm btn-champagne"
					>RSVP</a
				>
			</div>
		</div>
...
<style>
	...
	.holts-description {
		...
		gap: 16px;
		max-width: 100%; /* Or simply delete the max-width property entirely */
	}
