...
<style>
	...
	/* GP26 logo — matches header exactly, with !important to defeat the
	   generic `.footer div a` rule below */
	.nav-logo {
		font-family: var(--font-gp26) !important;
